...
public class Library {
    ...
    public User searchUser(String keyword)  { return users.search(keyword); }

    public Content[]       getContents()     { return contents; }
    public int             getContentCount() { return CCount;   }
    public UserLinkedList  getUsers()        { return users;    }
}
